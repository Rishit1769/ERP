...
const USERS_TEMPLATE_CSV = `erp_id,name,email,phone,role,department_code,year,semester
22001,Jane Smith,jane.smith@college.edu,9876543210,STUDENT,COMPS,2,3
10042,Prof. Raj Kumar,raj.kumar@college.edu,9123456780,SUBJECT_TEACHER,COMPS,,
10043,Dr. Priya HOD,priya.hod@college.edu,9012345678,HOD,IT,,
`;
